		...
		return (
			<Layout title="Viaja con Danilo">
				...
				<ProfessionalEquipment 
					...
					styleLeft={{width: '50%', paddingLeft: '10%', marginTop: 25}}
					bgRight="url(https://144ontour.com/wp-content/uploads/2017/11/Work-Travel-offer.jpg)"
				/>
				
				<PhotoAndVideo 
					stylePhotoAndVideo={{marginTop: -130}}
					styleWeb={{width: '43%', marginLeft: 40}}
					styleFree={{left: -100, background: 'linear-gradient(to right, rgba(255,255,255,0.2) 0%,rgba(237,237,237,0.4) 100%)', top: -100, color: 'black', padding: 90, paddingLeft: 180}}
					title="¿ES GRATIS?"
